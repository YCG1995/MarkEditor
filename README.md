...
[![version](https://img.shields.io/badge/version-1.0.5-blue)](https://github.com/YCG1995/MarkEditor/releases)
...
| 平台 | 下载 |
| --- | --- |
| Windows 10/11 x64 | [MarkEditor-1.0.5-windows-x64.zip](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-windows-x64.zip) |
| macOS Intel (x64) | [MarkEditor-1.0.5-macos-x64.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-macos-x64.tar.gz) |
| macOS Apple Silicon (M1+) | [MarkEditor-1.0.5-macos-arm64.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-macos-arm64.tar.gz) |
| macOS 通用 (Universal) | [MarkEditor-1.0.5-macos-universal.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-macos-universal.tar.gz) |
| Linux x64 | [MarkEditor-1.0.5-linux-x64.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-linux-x64.tar.gz) |
| Linux arm64 | [MarkEditor-1.0.5-linux-arm64.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-linux-arm64.tar.gz) |
| Linux armhf | [MarkEditor-1.0.5-linux-armhf.tar.gz](https://github.com/YCG1995/MarkEditor/releases/download/v1.0.5/MarkEditor-1.0.5-linux-armhf.tar.gz) |
